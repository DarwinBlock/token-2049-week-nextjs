						...
						<div className={"header-right navbar-collapse " + (collapsed ? "collapse" : "")} id="navbarSupportedContent">
							<ul className="navbar-nav">
								<li className="nav-item onlymb">
									<a href="https://www.dubai.token2049.com/tickets" className="nav-link">
										TICKETS
									</a>
								</li>
								<li className="nav-item">
									<a href="https://www.dubai.token2049.com/speakers" className="nav-link md:-ml-10">
										SPEAKERS
									</a>
								</li>
                ...
                <a href="https://www.asia.token2049.com/agenda" className="nav-link">AGENDA</a></div>
                  <div className="dropdown-content hide" id="dropdown-content">
                    ...
                    <a href="https://www.asia.token2049.com/kucoin-stage">KUCOIN STAGE</a>
								...
								<li className="nav-item">
									<a href="https://www.dubai.token2049.com/agenda" className="nav-link md:-ml-10">
										AGENDA
									</a>
								</li>
								<li className="nav-item">
								...
								<li className="nav-item md:-ml-[36px]">
